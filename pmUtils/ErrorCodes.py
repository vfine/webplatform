...
class ErrorCodes:
    ...
    def __init__(self):
        ...
        ## Panda errors can be found at https://twiki.cern.ch/twiki/bin/view/AtlasComputing/PandaErrorCodes
        ...
        self.errorCodes['exeErrorCode'][1008] = self.errorCodes['pilotErrorCode'][1008]
        self.errorStages['exeErrorCode'][1008] = self.errorStages['pilotErrorCode'][1008]
        self.errorCodes['exeErrorCode'][1097] = self.errorCodes['pilotErrorCode'][1097]
        self.errorStages['exeErrorCode'][1097] = self.errorStages['pilotErrorCode'][1097]
        self.errorCodes['exeErrorCode'][1098] = self.errorCodes['pilotErrorCode'][1098]
        self.errorStages['exeErrorCode'][1098] = self.errorStages['pilotErrorCode'][1098]
        self.errorCodes['exeErrorCode'][1099] = self.errorCodes['pilotErrorCode'][1099]
        self.errorStages['exeErrorCode'][1099] = self.errorStages['pilotErrorCode'][1099]
        self.errorCodes['exeErrorCode'][1100] = self.errorCodes['pilotErrorCode'][1100]
        self.errorStages['exeErrorCode'][1100] = self.errorStages['pilotErrorCode'][1100]
        self.errorCodes['exeErrorCode'][1101] = self.errorCodes['pilotErrorCode'][1101]
        self.errorStages['exeErrorCode'][1101] = self.errorStages['pilotErrorCode'][1101]
        self.errorCodes['exeErrorCode'][1102] = self.errorCodes['pilotErrorCode'][1102]
        self.errorStages['exeErrorCode'][1102] = self.errorStages['pilotErrorCode'][1102]
        self.errorCodes['exeErrorCode'][1103] = self.errorCodes['pilotErrorCode'][1103]
        self.errorStages['exeErrorCode'][1103] = self.errorStages['pilotErrorCode'][1103]
        self.errorCodes['exeErrorCode'][1104] = self.errorCodes['pilotErrorCode'][1104]
        self.errorStages['exeErrorCode'][1104] = self.errorStages['pilotErrorCode'][1104]
        self.errorCodes['exeErrorCode'][1105] = self.errorCodes['pilotErrorCode'][1105]
        self.errorStages['exeErrorCode'][1105] = self.errorStages['pilotErrorCode'][1105]
        self.errorCodes['exeErrorCode'][1106] = self.errorCodes['pilotErrorCode'][1106]
        self.errorStages['exeErrorCode'][1106] = self.errorStages['pilotErrorCode'][1106]
        self.errorCodes['exeErrorCode'][1107] = self.errorCodes['pilotErrorCode'][1107]
        self.errorStages['exeErrorCode'][1107] = self.errorStages['pilotErrorCode'][1107]
        self.errorCodes['exeErrorCode'][1108] = self.errorCodes['pilotErrorCode'][1108]
        self.errorStages['exeErrorCode'][1108] = self.errorStages['pilotErrorCode'][1108]
        self.errorCodes['exeErrorCode'][1109] = self.errorCodes['pilotErrorCode'][1109]
        self.errorStages['exeErrorCode'][1109] = self.errorStages['pilotErrorCode'][1109]
        self.errorCodes['exeErrorCode'][1110] = self.errorCodes['pilotErrorCode'][1110]
        self.errorStages['exeErrorCode'][1110] = self.errorStages['pilotErrorCode'][1110]
        self.errorCodes['exeErrorCode'][1111] = self.errorCodes['pilotErrorCode'][1111]
        self.errorStages['exeErrorCode'][1111] = self.errorStages['pilotErrorCode'][1111]
        self.errorCodes['exeErrorCode'][1112] = self.errorCodes['pilotErrorCode'][1112]
        self.errorStages['exeErrorCode'][1112] = self.errorStages['pilotErrorCode'][1112]
        self.errorCodes['exeErrorCode'][1113] = self.errorCodes['pilotErrorCode'][1113]
        self.errorStages['exeErrorCode'][1113] = self.errorStages['pilotErrorCode'][1113]
        self.errorCodes['exeErrorCode'][1114] = self.errorCodes['pilotErrorCode'][1114]
        self.errorStages['exeErrorCode'][1114] = self.errorStages['pilotErrorCode'][1114]
        self.errorCodes['exeErrorCode'][1115] = self.errorCodes['pilotErrorCode'][1115]
        self.errorStages['exeErrorCode'][1115] = self.errorStages['pilotErrorCode'][1115]
        self.errorCodes['exeErrorCode'][1116] = self.errorCodes['pilotErrorCode'][1116]
        self.errorStages['exeErrorCode'][1116] = self.errorStages['pilotErrorCode'][1116]
        self.errorCodes['exeErrorCode'][1117] = self.errorCodes['pilotErrorCode'][1117]
        self.errorStages['exeErrorCode'][1117] = self.errorStages['pilotErrorCode'][1117]
        self.errorCodes['exeErrorCode'][1118] = self.errorCodes['pilotErrorCode'][1118]
        self.errorStages['exeErrorCode'][1118] = self.errorStages['pilotErrorCode'][1118]
        self.errorCodes['exeErrorCode'][1119] = self.errorCodes['pilotErrorCode'][1119]
        self.errorStages['exeErrorCode'][1119] = self.errorStages['pilotErrorCode'][1119]
        self.errorCodes['exeErrorCode'][1120] = self.errorCodes['pilotErrorCode'][1120]
        self.errorStages['exeErrorCode'][1120] = self.errorStages['pilotErrorCode'][1120]
        self.errorCodes['exeErrorCode'][1121] = self.errorCodes['pilotErrorCode'][1121]
        self.errorStages['exeErrorCode'][1121] = self.errorStages['pilotErrorCode'][1121]
        self.errorCodes['exeErrorCode'][1122] = self.errorCodes['pilotErrorCode'][1122]
        self.errorStages['exeErrorCode'][1122] = self.errorStages['pilotErrorCode'][1122]
        self.errorCodes['exeErrorCode'][1123] = self.errorCodes['pilotErrorCode'][1123]
        self.errorStages['exeErrorCode'][1123] = self.errorStages['pilotErrorCode'][1123]
        self.errorCodes['exeErrorCode'][1124] = self.errorCodes['pilotErrorCode'][1124]
        self.errorStages['exeErrorCode'][1124] = self.errorStages['pilotErrorCode'][1124]
        self.errorCodes['exeErrorCode'][1130] = self.errorCodes['pilotErrorCode'][1130]
        self.errorStages['exeErrorCode'][1130] = self.errorStages['pilotErrorCode'][1130]
        self.errorCodes['exeErrorCode'][1131] = self.errorCodes['pilotErrorCode'][1131]
        self.errorStages['exeErrorCode'][1131] = self.errorStages['pilotErrorCode'][1131]
        self.errorCodes['exeErrorCode'][1132] = self.errorCodes['pilotErrorCode'][1132]
        self.errorStages['exeErrorCode'][1132] = self.errorStages['pilotErrorCode'][1132]
        self.errorCodes['exeErrorCode'][1133] = self.errorCodes['pilotErrorCode'][1133]
        self.errorStages['exeErrorCode'][1133] = self.errorStages['pilotErrorCode'][1133]
        self.errorCodes['exeErrorCode'][1134] = self.errorCodes['pilotErrorCode'][1134]
        self.errorStages['exeErrorCode'][1134] = self.errorStages['pilotErrorCode'][1134]
        self.errorCodes['exeErrorCode'][1135] = self.errorCodes['pilotErrorCode'][1135]
        self.errorStages['exeErrorCode'][1135] = self.errorStages['pilotErrorCode'][1135]
        self.errorCodes['exeErrorCode'][1136] = self.errorCodes['pilotErrorCode'][1136]
        self.errorStages['exeErrorCode'][1136] = self.errorStages['pilotErrorCode'][1136]
        self.errorCodes['exeErrorCode'][1137] = self.errorCodes['pilotErrorCode'][1137]
        self.errorStages['exeErrorCode'][1137] = self.errorStages['pilotErrorCode'][1137]
        self.errorCodes['exeErrorCode'][1138] = self.errorCodes['pilotErrorCode'][1138]
        self.errorStages['exeErrorCode'][1138] = self.errorStages['pilotErrorCode'][1138]
        self.errorCodes['exeErrorCode'][1139] = self.errorCodes['pilotErrorCode'][1139]
        self.errorStages['exeErrorCode'][1139] = self.errorStages['pilotErrorCode'][1139]
        self.errorCodes['exeErrorCode'][1140] = self.errorCodes['pilotErrorCode'][1140]
        self.errorStages['exeErrorCode'][1140] = self.errorStages['pilotErrorCode'][1140]
        self.errorCodes['exeErrorCode'][1141] = self.errorCodes['pilotErrorCode'][1141]
        self.errorStages['exeErrorCode'][1141] = self.errorStages['pilotErrorCode'][1141]
        self.errorCodes['exeErrorCode'][1142] = self.errorCodes['pilotErrorCode'][1142]
        self.errorStages['exeErrorCode'][1142] = self.errorStages['pilotErrorCode'][1142]
        self.errorCodes['exeErrorCode'][1143] = self.errorCodes['pilotErrorCode'][1143]
        self.errorStages['exeErrorCode'][1143] = self.errorStages['pilotErrorCode'][1143]
        self.errorCodes['exeErrorCode'][1144] = self.errorCodes['pilotErrorCode'][1144]
        self.errorStages['exeErrorCode'][1144] = self.errorStages['pilotErrorCode'][1144]
        self.errorCodes['exeErrorCode'][1145] = self.errorCodes['pilotErrorCode'][1145]
        self.errorStages['exeErrorCode'][1145] = self.errorStages['pilotErrorCode'][1145]
        self.errorCodes['exeErrorCode'][1146] = self.errorCodes['pilotErrorCode'][1146]
        self.errorStages['exeErrorCode'][1146] = self.errorStages['pilotErrorCode'][1146]
        self.errorCodes['exeErrorCode'][1147] = self.errorCodes['pilotErrorCode'][1147]
        self.errorStages['exeErrorCode'][1147] = self.errorStages['pilotErrorCode'][1147]
        self.errorCodes['exeErrorCode'][1148] = self.errorCodes['pilotErrorCode'][1148]
        self.errorStages['exeErrorCode'][1148] = self.errorStages['pilotErrorCode'][1148]
        self.errorCodes['exeErrorCode'][1149] = self.errorCodes['pilotErrorCode'][1149]
        self.errorStages['exeErrorCode'][1149] = self.errorStages['pilotErrorCode'][1149]
        self.errorCodes['exeErrorCode'][1150] = self.errorCodes['pilotErrorCode'][1150]
        self.errorStages['exeErrorCode'][1150] = self.errorStages['pilotErrorCode'][1150]
        self.errorCodes['exeErrorCode'][1151] = self.errorCodes['pilotErrorCode'][1151]
        self.errorStages['exeErrorCode'][1151] = self.errorStages['pilotErrorCode'][1151]
        self.errorCodes['exeErrorCode'][1152] = self.errorCodes['pilotErrorCode'][1152]
        self.errorStages['exeErrorCode'][1152] = self.errorStages['pilotErrorCode'][1152]
        self.errorCodes['exeErrorCode'][1153] = self.errorCodes['pilotErrorCode'][1153]
        self.errorStages['exeErrorCode'][1153] = self.errorStages['pilotErrorCode'][1153]
        self.errorCodes['exeErrorCode'][1154] = self.errorCodes['pilotErrorCode'][1154]
        self.errorStages['exeErrorCode'][1154] = self.errorStages['pilotErrorCode'][1154]
        self.errorCodes['exeErrorCode'][1155] = self.errorCodes['pilotErrorCode'][1155]
        self.errorStages['exeErrorCode'][1155] = self.errorStages['pilotErrorCode'][1155]
        self.errorCodes['exeErrorCode'][1156] = self.errorCodes['pilotErrorCode'][1156]
        self.errorStages['exeErrorCode'][1156] = self.errorStages['pilotErrorCode'][1156]
        self.errorCodes['exeErrorCode'][1157] = self.errorCodes['pilotErrorCode'][1157]
        self.errorStages['exeErrorCode'][1157] = self.errorStages['pilotErrorCode'][1157]
        self.errorCodes['exeErrorCode'][1158] = self.errorCodes['pilotErrorCode'][1158]
        self.errorStages['exeErrorCode'][1158] = self.errorStages['pilotErrorCode'][1158]
        self.errorCodes['exeErrorCode'][1159] = self.errorCodes['pilotErrorCode'][1159]
        self.errorStages['exeErrorCode'][1159] = self.errorStages['pilotErrorCode'][1159]
        self.errorCodes['exeErrorCode'][1160] = self.errorCodes['pilotErrorCode'][1160]
        self.errorStages['exeErrorCode'][1160] = self.errorStages['pilotErrorCode'][1160]
        self.errorCodes['exeErrorCode'][1161] = self.errorCodes['pilotErrorCode'][1161]
        self.errorStages['exeErrorCode'][1161] = self.errorStages['pilotErrorCode'][1161]
        self.errorCodes['exeErrorCode'][1162] = self.errorCodes['pilotErrorCode'][1162]
        self.errorStages['exeErrorCode'][1162] = self.errorStages['pilotErrorCode'][1162]
        self.errorCodes['exeErrorCode'][1163] = self.errorCodes['pilotErrorCode'][1163]
        self.errorStages['exeErrorCode'][1163] = self.errorStages['pilotErrorCode'][1163]
        self.errorCodes['exeErrorCode'][1164] = self.errorCodes['pilotErrorCode'][1164]
        self.errorStages['exeErrorCode'][1164] = self.errorStages['pilotErrorCode'][1164]
        self.errorCodes['exeErrorCode'][1165] = self.errorCodes['pilotErrorCode'][1165]
        self.errorStages['exeErrorCode'][1165] = self.errorStages['pilotErrorCode'][1165]
        self.errorCodes['exeErrorCode'][1166] = self.errorCodes['pilotErrorCode'][1166]
        self.errorStages['exeErrorCode'][1166] = self.errorStages['pilotErrorCode'][1166]
        self.errorCodes['exeErrorCode'][1167] = self.errorCodes['pilotErrorCode'][1167]
        self.errorStages['exeErrorCode'][1167] = self.errorStages['pilotErrorCode'][1167]
        self.errorCodes['exeErrorCode'][1168] = self.errorCodes['pilotErrorCode'][1168]
        self.errorStages['exeErrorCode'][1168] = self.errorStages['pilotErrorCode'][1168]
        self.errorCodes['exeErrorCode'][1169] = self.errorCodes['pilotErrorCode'][1169]
        self.errorStages['exeErrorCode'][1169] = self.errorStages['pilotErrorCode'][1169]
        self.errorCodes['exeErrorCode'][1170] = self.errorCodes['pilotErrorCode'][1170]
        self.errorStages['exeErrorCode'][1170] = self.errorStages['pilotErrorCode'][1170]
        self.errorCodes['exeErrorCode'][1171] = self.errorCodes['pilotErrorCode'][1171]
        self.errorStages['exeErrorCode'][1171] = self.errorStages['pilotErrorCode'][1171]
        self.errorCodes['exeErrorCode'][1172] = self.errorCodes['pilotErrorCode'][1172]
        self.errorStages['exeErrorCode'][1172] = self.errorStages['pilotErrorCode'][1172]
        self.errorCodes['exeErrorCode'][1173] = self.errorCodes['pilotErrorCode'][1173]
        self.errorStages['exeErrorCode'][1173] = self.errorStages['pilotErrorCode'][1173]
        self.errorCodes['exeErrorCode'][1174] = self.errorCodes['pilotErrorCode'][1174]
        self.errorStages['exeErrorCode'][1174] = self.errorStages['pilotErrorCode'][1174]
        self.errorCodes['exeErrorCode'][1175] = self.errorCodes['pilotErrorCode'][1175]
        self.errorStages['exeErrorCode'][1175] = self.errorStages['pilotErrorCode'][1175]
        self.errorCodes['exeErrorCode'][1176] = self.errorCodes['pilotErrorCode'][1176]
        self.errorStages['exeErrorCode'][1176] = self.errorStages['pilotErrorCode'][1176]
        self.errorCodes['exeErrorCode'][1177] = self.errorCodes['pilotErrorCode'][1177]
        self.errorStages['exeErrorCode'][1177] = self.errorStages['pilotErrorCode'][1177]
        self.errorCodes['exeErrorCode'][1178] = self.errorCodes['pilotErrorCode'][1178]
        self.errorStages['exeErrorCode'][1178] = self.errorStages['pilotErrorCode'][1178]
        self.errorCodes['exeErrorCode'][1179] = self.errorCodes['pilotErrorCode'][1179]
        self.errorStages['exeErrorCode'][1179] = self.errorStages['pilotErrorCode'][1179]
        self.errorCodes['exeErrorCode'][1180] = self.errorCodes['pilotErrorCode'][1180]
        self.errorStages['exeErrorCode'][1180] = self.errorStages['pilotErrorCode'][1180]
        self.errorCodes['exeErrorCode'][1181] = self.errorCodes['pilotErrorCode'][1181]
        self.errorStages['exeErrorCode'][1181] = self.errorStages['pilotErrorCode'][1181]
        self.errorCodes['exeErrorCode'][1182] = self.errorCodes['pilotErrorCode'][1182]
        self.errorStages['exeErrorCode'][1182] = self.errorStages['pilotErrorCode'][1182]
        self.errorCodes['exeErrorCode'][1183] = self.errorCodes['pilotErrorCode'][1183]
        self.errorStages['exeErrorCode'][1183] = self.errorStages['pilotErrorCode'][1183]
        self.errorCodes['exeErrorCode'][1184] = self.errorCodes['pilotErrorCode'][1184]
        self.errorStages['exeErrorCode'][1184] = self.errorStages['pilotErrorCode'][1184]
        self.errorCodes['exeErrorCode'][1185] = self.errorCodes['pilotErrorCode'][1185]
        self.errorStages['exeErrorCode'][1185] = self.errorStages['pilotErrorCode'][1185]
        self.errorCodes['exeErrorCode'][1186] = self.errorCodes['pilotErrorCode'][1186]
        self.errorStages['exeErrorCode'][1186] = self.errorStages['pilotErrorCode'][1186]
        self.errorCodes['exeErrorCode'][1187] = self.errorCodes['pilotErrorCode'][1187]
        self.errorStages['exeErrorCode'][1187] = self.errorStages['pilotErrorCode'][1187]
        self.errorCodes['exeErrorCode'][1188] = self.errorCodes['pilotErrorCode'][1188]
        self.errorStages['exeErrorCode'][1188] = self.errorStages['pilotErrorCode'][1188]
        self.errorCodes['exeErrorCode'][1189] = self.errorCodes['pilotErrorCode'][1189]
        self.errorStages['exeErrorCode'][1189] = self.errorStages['pilotErrorCode'][1189]
        self.errorCodes['exeErrorCode'][1190] = self.errorCodes['pilotErrorCode'][1190]
        self.errorStages['exeErrorCode'][1190] = self.errorStages['pilotErrorCode'][1190]
        self.errorCodes['exeErrorCode'][1198] = self.errorCodes['pilotErrorCode'][1198]
        self.errorStages['exeErrorCode'][1198] = self.errorStages['pilotErrorCode'][1198]
        self.errorCodes['exeErrorCode'][1199] = self.errorCodes['pilotErrorCode'][1199]
        self.errorStages['exeErrorCode'][1199] = self.errorStages['pilotErrorCode'][1199]
        self.errorCodes['exeErrorCode'][1200] = self.errorCodes['pilotErrorCode'][1200]
        self.errorStages['exeErrorCode'][1200] = self.errorStages['pilotErrorCode'][1200]
        self.errorCodes['exeErrorCode'][1201] = self.errorCodes['pilotErrorCode'][1201]
        self.errorStages['exeErrorCode'][1201] = self.errorStages['pilotErrorCode'][1201]
        self.errorCodes['exeErrorCode'][1202] = self.errorCodes['pilotErrorCode'][1202]
        self.errorStages['exeErrorCode'][1202] = self.errorStages['pilotErrorCode'][1202]
        self.errorCodes['exeErrorCode'][1203] = self.errorCodes['pilotErrorCode'][1203]
        self.errorStages['exeErrorCode'][1203] = self.errorStages['pilotErrorCode'][1203]
        self.errorCodes['exeErrorCode'][1204] = self.errorCodes['pilotErrorCode'][1204]
        self.errorStages['exeErrorCode'][1204] = self.errorStages['pilotErrorCode'][1204]
        self.errorCodes['exeErrorCode'][1205] = self.errorCodes['pilotErrorCode'][1205]
        self.errorStages['exeErrorCode'][1205] = self.errorStages['pilotErrorCode'][1205]
        self.errorCodes['exeErrorCode'][1210] = self.errorCodes['pilotErrorCode'][1210]
        self.errorStages['exeErrorCode'][1210] = self.errorStages['pilotErrorCode'][1210]
        self.errorCodes['exeErrorCode'][1211] = self.errorCodes['pilotErrorCode'][1211]
        self.errorStages['exeErrorCode'][1211] = self.errorStages['pilotErrorCode'][1211]
        self.errorCodes['exeErrorCode'][1212] = self.errorCodes['pilotErrorCode'][1212]
        self.errorStages['exeErrorCode'][1212] = self.errorStages['pilotErrorCode'][1212]
        self.errorCodes['exeErrorCode'][1220] = self.errorCodes['pilotErrorCode'][1220]
        self.errorStages['exeErrorCode'][1220] = self.errorStages['pilotErrorCode'][1220]
    # errors at http://alxr.usatlas.bnl.gov/lxr/source/atlas/Tools/PyJobTransformsCore/share/atlas_error_categories.db?v=current
        ...
        self.errorCodes['exeErrorCode'][66010] = 'GriBB: Process exceeded the maximum time limit'
        self.errorStages['exeErrorCode'][66010] = 'athena-during'
        self.errorCodes['exeErrorCode'][66020] = 'GriBB: Process exceeded the maximum memory limit'
        self.errorStages['exeErrorCode'][66020] = 'athena-during'
        self.errorCodes['exeErrorCode'][66030] = 'GriBB: Maximum (screen) output size exceeded'
        self.errorStages['exeErrorCode'][66030] = 'athena-during'
        self.errorCodes['exeErrorCode'][66040] = 'GriBB: Process hanging (not using CPU)'
        self.errorStages['exeErrorCode'][66040] = 'athena-during'
        self.errorCodes['exeErrorCode'][66050] = 'GriBB: Cannot start the process'
        self.errorStages['exeErrorCode'][66050] = 'athena-during'
